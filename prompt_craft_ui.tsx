...
import { Zap, Code, Feather, BookOpen, Brain, Copy, Check, Settings, Info, ChevronDown, Sparkles, Eye, EyeOff } from 'lucide-react';
...
const PromptCraftUI = () => {
  ...
  const handleEnhance = () => {
    ...
    let enhanced = template.replace("{user_input}", userInput);
    enhanced = enhanced.replace("{model_instructions}", modelInst);
  ...
  const TemplateIcon = config.templates[selectedTemplate].icon;
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="group-hover:text-cyan-300">{config.templates[selectedTemplate].name}</span>
              </div>
        ...
        <div className="button-container">
          <div
            ...
            style={{
                ...
                opacity: (!userInput.trim() || isProcessing) ? 0.6 : 1
            }}
          >
